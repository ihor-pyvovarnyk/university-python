...
3. Перевірити валідність створеного `swagger.yaml` за допомогою [editor.swagger.io](https://editor.swagger.io)
...
3. Використані коректні HTTP методи та коди відповідей 
2. Студент має описати словами створену модель API
